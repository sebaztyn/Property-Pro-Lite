...
if (myPropertyList) {
  myPropertyList.addEventListener('click', () => {
    location.href = 'my-list.html';
  });
}
if (ulDashboard) {
  ulDashboard.addEventListener('click', () => {
...
if (dashboardProfile) {
  dashboardProfile.addEventListener('click', (event) => {
    event.stopPropagation();
    location.href = 'profile.html';
  });
}
if (dashboardMyPropertyList) {
  dashboardMyPropertyList.addEventListener('click', () => {
    location.href = 'my-list.html';
  });
}
if (signupLink) {
...
if (listPropertyLink) {
  listPropertyLink.addEventListener('click', () => {
...
signoutTwo.addEventListener('click', (event) => {
  localStorage.removeItem('signup');
  localStorage.removeItem('login');
  location.href = 'index.html';
});
